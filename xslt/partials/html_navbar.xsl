...
<xsl:stylesheet 
    ...
    <xsl:template match="/" name="nav_bar">
        <div class="wrapper-fluid wrapper-navbar hide-reading" id="wrapper-navbar" >  <!--class: sticky-navbar -->
            <a class="skip-link screen-reader-text sr-only" href="#content">Skip to content</a>
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container" >
                    <!-- Your site title as branding in the menu -->
                    <a href="index.html" class="navbar-brand custom-logo-link" rel="home" itemprop="url"><img src="img/freud_logo.png" class="img-fluid" title="{$project_short_title}" alt="{$project_short_title}" itemprop="logo" /></a><!-- end custom logo -->
